...
```sh
git clone https://github.com/ethanuppal/libcmdapp
cd libcmdapp
make
```
This will build the static and dynamic libraries alongside a test program called `demo`.
...
This may come soon, but the header file [`cmdapp.h`](src/cmdapp.h) is heavily commented.
